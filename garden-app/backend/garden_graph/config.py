...
MODEL_PROVIDERS = {
    ...
    "llama3-": "groq",
    "mixtral": "groq",
    # OpenRouter — generic prefix
    "openrouter/": "openrouter",
    # OpenRouter — direct vendor prefixes (no need to write "openrouter/qwen/...")
    "qwen/": "openrouter",
...
def get_llm(model_name: str, temperature: float = 0.7, **kwargs):
    ...
    try:
        if provider == "openai" and OPENAI_API_KEY:
            ...
            # Strip "openrouter/" prefix if present — direct vendor prefixes
            # (qwen/, moonshotai/, z-ai/, deepseek/) pass through as-is.
            or_model = model_name
            if or_model.startswith("openrouter/"):
                or_model = or_model[len("openrouter/"):]
            ...
            return ChatOpenAI(
                ...
                default_headers={
                    "HTTP-Referer": "https://github.com/nikshilov/garden",
                    "X-Title": "Garden",
                },
                **kwargs,
            )
