...
public final class APIClient {
    ...
    public func sendMessage(text: String, characterId: String?) async throws -> ChatResponse {
        ...
        let model = UserDefaults.standard.string(forKey: "selectedModel") ?? LLMModel.gpt4o.rawValue
        // Validate model is known, fallback to gpt-4o
        let validModel = LLMModel(rawValue: model) != nil ? model : LLMModel.gpt4o.rawValue
        payload["model"] = validModel
#if DEBUG
        print("APIClient: model = \(validModel)")
#endif
