...
struct ChatBubble: View {
    ...
    let metaProvider: (String) -> (cost: Double?, time: TimeInterval?, model: String?, promptTokens: Int?, completionTokens: Int?)
        ...
        HStack(alignment: .bottom, spacing: 8) {
            ...
            VStack(alignment: isCurrent ? .trailing : .leading, spacing: 4) {
                ...
                if showCostMeta {
                    ...
                    if meta.cost != nil || meta.time != nil || meta.model != nil {
                        VStack(alignment: isCurrent ? .trailing : .leading, spacing: 2) {
                            ...
                            HStack(spacing: 8) {
                                ...
                                if let pt = meta.promptTokens, let ct = meta.completionTokens {
                                    Label("\(pt)+\(ct)t", systemImage: "arrow.left.arrow.right")
                                        .font(.system(size: 9, weight: .medium, design: .monospaced))
