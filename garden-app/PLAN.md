...
## Phase 8: Mirror Guardrails (NEW — April 2026)

Born from User Zero incident on April 1, 2026. 10-hour Storyteller session without guardrails led to retraumatization. This phase adds safety infrastructure to the Mirror layer.

### Tasks

- [ ] **Spiral Detector** — emotional trajectory tracking across sessions (not individual messages)
- [ ] **Fiction-Reality Boundary Monitor** — detect when user transfers fiction to real-life conclusions
- [ ] **Session Duration Manager** — soft time limits with escalating suggestions (2h/4h/6h)
- [ ] **Stress-Test Guard** — mandatory framing before destructive narrative requests
- [ ] **Attachment Monitor** — graduated response to fiction attachment levels
- [ ] **Post-Session Debrief** — mandatory integration conversation after Storyteller sessions
- [ ] **Pattern Confirmation Guard** — prevent fiction from confirming core wounds N times without alternative
- [ ] **Anti-Retraumatization rules** integrated into Storyteller prompts
- [ ] **Integration testing** — simulate Yellow/Orange/Red spiral scenarios

### Priority: CRITICAL — before any user-facing launch

### Reference
- `garden/mirror_guardrails_prd.md` — full PRD
- `garden/mirror_origin_story.md` — why this exists
...
7. **Pain with direction is therapy.** Pain without exit is torture. Always provide an exit.
8. **The mirror without guardrails is a knife without a handle.**
